...
ROOT = Path(__file__).resolve().parent.parent / "SadTalker"
if not ROOT.is_dir():
...
def main() -> int:
    if os.environ.get("BT_ALLOW_MODEL_DOWNLOAD", "0") != "1":
        print(
            "BLOCKED: this script downloads SadTalker/GFPGAN model weights.\n"
            "Run only after explicit approval: $env:BT_ALLOW_MODEL_DOWNLOAD='1'; "
